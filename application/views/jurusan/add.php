        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <?php echo form_open('jurusan/add', 'class="needs-validation" novalidate'); ?>
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="kode_jurusan" 
                                           name="kode_jurusan" 
                                           value="<?php echo set_value('kode_jurusan'); ?>"
                            ...
                            <div class="col-md-8">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="nama_jurusan" 
                                           name="nama_jurusan" 
                                           value="<?php echo set_value('nama_jurusan'); ?>"
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              name="deskripsi" 
                                              rows="3" 
                                              placeholder="Deskripsi jurusan (opsional)"><?php echo set_value('deskripsi'); ?></textarea>
