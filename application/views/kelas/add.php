        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <?php echo form_open('kelas/add', 'class="needs-validation" novalidate'); ?>
                    <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select <?php echo form_error('id_tingkatan') ? 'is-invalid' : ''; ?>" 
                                        ...
                                        <?php foreach ($tingkatan as $t): ?>
                                            <option value="<?php echo $t->id_tingkatan; ?>" <?php echo set_select('id_tingkatan', $t->id_tingkatan); ?>>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select <?php echo form_error('id_jurusan') ? 'is-invalid' : ''; ?>" 
                                        ...
                                        <?php foreach ($jurusan as $j): ?>
                                            <option value="<?php echo $j->id_jurusan; ?>" <?php echo set_select('id_jurusan', $j->id_jurusan); ?>>
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="rombel" 
                                           name="rombel" 
                                           value="<?php echo set_value('rombel'); ?>"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="kapasitas" 
                                           name="kapasitas" 
                                           value="<?php echo set_value('kapasitas', '36'); ?>"
                                           placeholder="36"
                                           min="1"
                                           max="50"
                                           required>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-info">
                                    <h6><i class="fas fa-eye"></i> Preview Nama Kelas:</h6>
                                    <h4 id="preview-nama-kelas" class="text-primary">-</h4>
                                    <small class="text-muted">Nama kelas akan dibuat otomatis berdasarkan tingkatan, jurusan, dan rombel yang dipilih</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="alert alert-success mt-3">
                            <h6><i class="fas fa-info-circle"></i> Panduan Pembuatan Kelas</h6>
                            <ul class="mb-0">
