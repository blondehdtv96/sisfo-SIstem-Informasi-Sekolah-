        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <?php echo form_open('matapelajaran/edit/' . $matapelajaran->id_mapel, 'class="needs-validation" novalidate'); ?>
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="kode_mapel" 
                                           name="kode_mapel" 
                                           value="<?php echo set_value('kode_mapel', $matapelajaran->kode_mapel); ?>"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select <?php echo form_error('kategori') ? 'is-invalid' : ''; ?>" 
                                        ...
                                        <option value="umum" <?php echo set_select('kategori', 'umum', $matapelajaran->kategori == 'umum'); ?>>Umum</option>
                                        <option value="kejuruan" <?php echo set_select('kategori', 'kejuruan', $matapelajaran->kategori == 'kejuruan'); ?>>Kejuruan</option>
                                        <option value="muatan_lokal" <?php echo set_select('kategori', 'muatan_lokal', $matapelajaran->kategori == 'muatan_lokal'); ?>>Muatan Lokal</option>
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-8">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="nama_mapel" 
                                           name="nama_mapel" 
                                           value="<?php echo set_value('nama_mapel', $matapelajaran->nama_mapel); ?>"
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select <?php echo form_error('status') ? 'is-invalid' : ''; ?>" 
                                        ...
                                        <option value="aktif" <?php echo set_select('status', 'aktif', $matapelajaran->status == 'aktif'); ?>>Aktif</option>
                                        <option value="nonaktif" <?php echo set_select('status', 'nonaktif', $matapelajaran->status == 'nonaktif'); ?>>Tidak Aktif</option>
                                    </select>
                                    <div class="invalid-feedback">
