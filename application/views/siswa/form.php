  ...
  if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form 
    ...
    foreach($sheet as $row){ 
      ...
      if($numrow > 1){
        ...
        $nim_td = ( ! empty($nisn))? "" : " style='background: #E07171;'"; // Jika NIS kosong, beri warna merah
        ...
        if(empty($nisn) or empty($nama) or empty($tanggal_lahir) or empty($tempat_lahir)){
          $kosong++; // Tambah 1 variabel $kosong
        }
        
        echo "<tr>";
        echo "<td".$nim_td.">".$nisn."</td>";
