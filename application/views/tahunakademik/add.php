        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <?php echo form_open('tahunakademik/add', 'class="needs-validation" novalidate'); ?>
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="tahun_ajar" 
                                           name="tahun_ajar" 
                                           value="<?php echo set_value('tahun_ajar'); ?>"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select <?php echo form_error('status') ? 'is-invalid' : ''; ?>" 
                                        ...
                                        <option value="nonaktif" <?php echo set_select('status', 'nonaktif', TRUE); ?>>Tidak Aktif</option>
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              name="keterangan" 
                                              rows="3" 
                                              placeholder="Keterangan tahun akademik (opsional)"><?php echo set_value('keterangan'); ?></textarea>
