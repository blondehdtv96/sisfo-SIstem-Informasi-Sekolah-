        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <?php echo form_open('tingkatan/edit/' . $tingkatan->id_tingkatan, 'class="needs-validation" novalidate'); ?>
                    <div class="card-body">
                            ...
                            <div class="col-md-8">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="nama_tingkatan" 
                                           name="nama_tingkatan" 
                                           value="<?php echo set_value('nama_tingkatan', $tingkatan->nama_tingkatan); ?>"
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" 
                                              ...
                                              name="keterangan" 
                                              rows="3" 
                                              placeholder="Keterangan tingkatan (opsional)"><?php echo set_value('keterangan', $tingkatan->keterangan); ?></textarea>
