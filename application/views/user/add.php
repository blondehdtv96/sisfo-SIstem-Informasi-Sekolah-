...
<div class="page-title">
    <h1><i class="fas fa-user-plus me-3"></i>Tambah User/Admin</h1>
    <p class="subtitle">Tambahkan akun user atau administrator baru</p>
</div>
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                <?php echo form_open('user/add', ['class' => 'needs-validation', 'novalidate' => '']); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <?php endif; ?>
                        <small class="form-text text-muted">Username harus unik dan tidak boleh sama dengan yang sudah ada.</small>
                    </div>
                        ...
                        <select class="form-select <?php echo form_error('id_level') ? 'is-invalid' : ''; ?>" 
                            ...
                            <?php foreach ($levels as $level): ?>
                                <option value="<?php echo $level->id_level; ?>" 
                                        <?php echo set_select('id_level', $level->id_level); ?>>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control <?php echo form_error('password') ? 'is-invalid' : ''; ?>" 
                                   id="password" name="password" placeholder="Masukkan password" required minlength="6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?php echo form_error('nama_lengkap') ? 'is-invalid' : ''; ?>" 
                           id="nama_lengkap" name="nama_lengkap" value="<?php echo set_value('nama_lengkap'); ?>" 
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="no_telp" name="no_telp" 
                               value="<?php echo set_value('no_telp'); ?>" placeholder="08xx-xxxx-xxxx">
                    </div>
                </div>
...
// Username availability check (optional - you can implement AJAX check)
